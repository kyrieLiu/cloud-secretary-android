...
public class MineActivity extends BaseActivity {
    ...
    private void initFunctionMenu() {
        String menus[] = {"我的发布", "我的收藏", "我的足迹","我的名片","工作日志","退出登录"};
        int icons[] = {R.mipmap.mine_active, R.mipmap.mine_collect, R.mipmap.mine_dynamic,
                R.mipmap.mine_file,R.mipmap.mine_schedule,R.mipmap.mine_setting};
        ...
        MineMenuAdapter adapter = new MineMenuAdapter(list, this);
