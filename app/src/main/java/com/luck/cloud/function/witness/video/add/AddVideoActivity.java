package com.luck.cloud.function.witness.video.add;
...
public class AddVideoActivity extends BaseActivity {
    private final static String TAG = AddVideoActivity.class.getSimpleName();
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        mAdapter = new AddVideoAdapter(getContext(), onAddPicClickListener);
            ...
            if (selectList.size() > 0) {
                ...
                switch (mediaType) {
                    case PictureConfig.TYPE_VIDEO:
                        // 预览视频
                        PictureSelector.create(AddVideoActivity.this)
    ...
    private AddVideoAdapter.onAddPicClickListener onAddPicClickListener = new AddVideoAdapter.onAddPicClickListener() {
        @Override
...
//        }else{
    ...
    private static class MyResultCallback implements OnResultCallbackListener<LocalMedia> {
        private WeakReference<AddVideoAdapter> mAdapterWeakReference;

        public MyResultCallback(AddVideoAdapter adapter) {
            super();
