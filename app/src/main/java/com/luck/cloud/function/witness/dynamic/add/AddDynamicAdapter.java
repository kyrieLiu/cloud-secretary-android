 ...
 */
public class AddDynamicAdapter extends
        RecyclerView.Adapter<AddDynamicAdapter.ViewHolder> {
    ...
    public AddDynamicAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
